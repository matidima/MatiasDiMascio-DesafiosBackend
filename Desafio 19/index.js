...
import { AuthRouter, InfoRouter, RandomRouter, ProductRouter } from "./src/routers/router.js";
...
import { schemaProduct } from './src/graphql/schemaGraphQL.js'
import { functionsGraphQL } from './src/graphql/graphql.helpers.js'
...
app.use('/graphql', graphqlHTTP({
    ...
    rootValue: {
        getProductById: functionsGraphQL.getProductById,
        getAllProducts: functionsGraphQL.getAllProducts,
        createProduct: functionsGraphQL.createProduct,
        deleteProductById: functionsGraphQL.deleteProductById,
        updateProductById: functionsGraphQL.updateProductById
    },
    graphiql: true
}))
